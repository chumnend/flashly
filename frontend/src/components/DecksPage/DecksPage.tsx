        ...
        <div className="decks">
            ...
            <div className="decks__body">
                ...
                {!loading && !error && decks.length === 0 && (
                    ...
                    <button className="decks__empty-btn" onClick={openModal}>
                        Create a deck
                    </button>
                    </div>
                )}
                ...
                {!loading && !error && decks.length > 0 && (
                    ...
                    {decks.map((deck, i) => (
                        <div key={deck.id} className="decks__card-wrap" style={{ animationDelay: `${i * 0.04}s` }}>
                        <DeckCard deck={deck} />
                        <Link
            ...
            {showModal && (
                <div className="decks__overlay" onClick={closeModal}>
                    <div className="decks__modal" onClick={e => e.stopPropagation()}>
                        <div className="decks__modal-header">
                            <h2 className="decks__modal-title">New deck</h2>
                            <button className="decks__modal-close" onClick={closeModal}>✕</button>
                        </div>

                        <div className="decks__modal-body">    
                            <div className="decks__field">
                                <label className="decks__label" htmlFor="deck-name">Name</label>
                                <input
                            ...
                            <div className="decks__field">
                                <label className="decks__label" htmlFor="deck-desc">Description</label>
                                <textarea
                            ...
                            <div className="decks__field">
                                ...
                                <div className="decks__toggle">
                                    ...
                                    onClick={() => setForm(f => ({ ...f, publishStatus: 'public' }))}
                                    type="button"
                                    >
                                    Public
                                    </button>
                            ...
                            {formError && <p className="decks__form-error">{formError}</p>}
                        </div>

                        <div className="decks__modal-footer">
                            <button className="decks__cancel-btn" onClick={closeModal}>Cancel</button>
                            <button className="decks__create-btn" onClick={handleCreate} disabled={creating}>
